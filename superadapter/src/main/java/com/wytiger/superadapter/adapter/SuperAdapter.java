package com.wytiger.superadapter.adapter;
...
import com.wytiger.superadapter.LayoutDataWrapper;
import com.wytiger.superadapter.SuperViewHolder;
...
public class SuperAdapter extends RecyclerView.Adapter<SuperViewHolder> {
    ...
    private List<LayoutDataWrapper> items = new ArrayList<>();
    ...
    public void onBindViewHolder(SuperViewHolder holder, int position) {
        LayoutDataWrapper wrapper = items.get(position);
    ...
    //设置数据源
    public void replaceData(List<LayoutDataWrapper> list) {
        this.items = list;
//        notifyDataSetChanged();
    }

    //设置数据源
    public void addData(List<LayoutDataWrapper> list) {
