 ...
 * 布局数据包装类
 */
public class LayoutDataWrapper<T> {
    ...
    //默认每个Item占spanSize列
    public LayoutDataWrapper(int layoutId, int spanSize, T data, DataHolder<T> holder) {
    ...
    //默认每个Item占一列
    public LayoutDataWrapper(int layoutId, T data, DataHolder<T> holder) {
        this.layoutId = layoutId;
        this.spanSize = 1;
        this.data = data;
        this.holder = holder;
